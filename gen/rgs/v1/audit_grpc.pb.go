...
func (c *auditServiceClient) ListRemoteAccessActivities(ctx context.Context, in *ListRemoteAccessActivitiesRequest, opts ...grpc.CallOption) (*ListRemoteAccessActivitiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRemoteAccessActivitiesResponse)
	err := c.cc.Invoke(ctx, AuditService_ListRemoteAccessActivities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuditService_ListRemoteAccessActivities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRemoteAccessActivitiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuditServiceServer).ListRemoteAccessActivities(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuditService_ListRemoteAccessActivities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServiceServer).ListRemoteAccessActivities(ctx, req.(*ListRemoteAccessActivitiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rgs.v1.AuditService",
