...
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEY_COMMAND="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEY_COMMAND:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS_FILE="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS_FILE:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS_COMMAND="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PRIVATE_KEYS_COMMAND:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY_FILE="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY_FILE:-}" \
RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY_COMMAND="${RGS_VERIFY_EVIDENCE_ATTESTATION_ED25519_PUBLIC_KEY_COMMAND:-}" \
