...
- Status: implemented (record/list bonus transactions, record promotional awards, submit/list system-window events with DB-backed persistence when configured; strict production disables in-memory promotions/UI mirrors)
